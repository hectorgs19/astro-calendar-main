          ...
          <div className="flex flex-auto">
            ...
            <div className="grid flex-auto grid-cols-1 grid-rows-1">
              ...
              <div
                ...
                style={{ gridTemplateRows: 'repeat(34, minmax(3.5rem, 1fr))' }}
              >
              ...
              {/* Vertical lines */}
              <div className="col-start-1 col-end-2 row-start-1 hidden grid-cols-6 grid-rows-1 divide-x divide-gray-100 sm:grid sm:grid-cols-5">
